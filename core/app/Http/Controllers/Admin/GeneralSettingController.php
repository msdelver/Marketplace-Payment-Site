...
class GeneralSettingController extends Controller {
    ...
    public function update(Request $request) {
        $request->validate([
            ...
            'timezone'        => 'required',
            'ad_duration'     => 'required|integer|gt:0',
        ]);
        ...
        $general->ad_duration     = $request->ad_duration;
    ...
    public function noticeForBuyer() {

        $pageTitle = 'Notice for Buyer';

        return view('admin.notice.index', compact('pageTitle'));
    }

    public function noticeUpdate(Request $request) {
        $request->validate([
            'notice'          => 'required|array',
            'notice.heading'  => 'required',
            'notice.notice'   => 'required',
        ]);

        $general = GeneralSetting::first();
        $general->notice_for_buyer = $request->notice;
        $general->save();
