    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--danger b-radius--10 box-shadow ">
            ...
            <div class="details">
                ...
                <div class="desciption">
                    <span class="text--small">@lang('Email Unverified Users')</span>
                </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--red b-radius--10 box-shadow ">
            ...
            <div class="details">
                ...
                <div class="desciption">
                    <span class="text--small">@lang('SMS Unverified Users')</span>
                </div>
...
<div class="row mt-50 mb-none-30">
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--warning b-radius--10 box-shadow">
            ...
            <div class="details">
                <div class="numbers">
                    <span class="amount">{{ showAmount($domain['pendingAmount']) }}&nbsp;{{ $general->cur_text }}</span>
                </div>
                <div class="desciption">
                    <span>@lang('Pending Domain')</span>
                </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--green b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <div class="numbers">
                    <span class="amount">{{ showAmount($domain['approvedAmount']) }}&nbsp;{{ $general->cur_text
                        }}</span>
                </div>
                <div class="desciption">
                    <span>@lang('Approved Domain')</span>
                </div>
                <a href="{{ route('admin.domain.approved') }}"
                    class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--success b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <div class="numbers">
                    <span class="amount">{{ showAmount($domain['soldAmount']) }}&nbsp;{{ $general->cur_text }}</span>
                </div>
                <div class="desciption">
                    <span>@lang('Sold Domain')</span>
                </div>
                <a href="{{ route('admin.domain.sold') }}"
                    class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--5 b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <div class="numbers">
                    <span class="amount">{{ showAmount($domain['rejectedAmount']) }}&nbsp;{{ $general->cur_text
                        }}</span>
                </div>
                <div class="desciption">
                    <span>@lang('Rejected Domain')</span>
                </div>
                <a href="{{ route('admin.domain.rejected') }}"
                    class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
            </div>
        </div>
    </div>
