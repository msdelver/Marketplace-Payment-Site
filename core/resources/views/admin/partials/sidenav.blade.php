    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.extension.domain.index')}}">
                    <a href="{{route('admin.extension.domain.index')}}" class="nav-link"
                        data-default-url="{{ route('admin.extension.domain.index') }}">
                        <i class="menu-icon las la-wind"></i>
                        <span class="menu-title">@lang('Domain Extensions') </span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.domain*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.domain.all')}} ">
                                <a href="{{route('admin.domain.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Domains')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.domain.pending')}} ">
                                <a href="{{route('admin.domain.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Domains')</span>
                                    @if($pending_domain_count)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$pending_domain_count}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.domain.approved')}} ">
                                <a href="{{route('admin.domain.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Domains')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.domain.finished')}} ">
                                <a href="{{route('admin.domain.finished')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Finished Domains')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.domain.sold')}} ">
                                <a href="{{route('admin.domain.sold')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Sold Domains')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.domain.rejected')}} ">
                                <a href="{{route('admin.domain.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Domains')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.domain.bid.reported')}}">
                                <a href="{{route('admin.domain.bid.reported')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Reported Bids')</span>
                                    @if($reported_bids_count)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$reported_bids_count}}</span>
                                    @endif
                                </a>
                            </li>
                        </ul>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.gateway*',3)}}">
                        <i class="menu-icon lab la-paypal"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.notice.index')}}">
                    <a href="{{route('admin.notice.index')}}" class="nav-link">
                        <i class="menu-icon las la-exclamation-triangle"></i>
                        <span class="menu-title">@lang('Notice for Buyer')</span>
                    </a>
                </li>
