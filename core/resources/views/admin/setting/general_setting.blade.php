            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="select2-basic" name="timezone">
                                ...
                                <option value="'{{ @$timezone}}'" @if(config('app.timezone')==$timezone) selected
                                    @endif>{{ __($timezone) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-2">
                            <label class="font-weight-bold">@lang('Ad duration (seconds)')</label>
                            <input type="text" class="form-control form-control-lg" name="ad_duration"
                                value="{{$general->ad_duration}}" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <label class="form-control-label font-weight-bold">@lang('Domain Auto Approval')</label>
                            <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                ...
                                data-off="@lang('Disabled')" name="auto_approve" @if($general->auto_approve)
                            checked @endif>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                                data-off="@lang('Disabled')" name="secure_password" @if($general->secure_password)
                            checked @endif>
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="row">
                        <div class="form-group col-md-2">
                            ...
                            <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                                data-off="@lang('Disabled')" name="registration" @if($general->registration) checked
                            @endif>
                        </div>
